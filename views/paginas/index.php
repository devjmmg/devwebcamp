<?php include_once __DIR__ . "/../paginas/conferencias.php" ?>

<section class="resumen">
    <div class="resumen__grid">
        <div <?php echo aos_efectos(); ?> class="resumen__bloque">
...
<section class="speakers">
    ...
    <p class="speakers__description">Conoce a nuestros expertos de Desarrollo Web en DevWebCamp</p>
    ...
    <div class="speakers__grid">
        ...
        <div <?php echo aos_efectos(); ?> class="speaker">
            ...
            <div class="speaker__informacion">
                ...
                <p class="speaker__ubicacion"><?php echo $ponente->pais . ', ' . $ponente->ciudad; ?></p>
            </div>
...
<section class="boletos">
    ...
    <p class="boletos__description">Precios para DevWebCamp</p>

    <div class="boletos__grid">
        <div <?php echo aos_efectos(); ?> class="boleto boleto--presencial">
            <h4 class="boleto__logo">&#60;DevWebCamp/></h4>
            <p class="boleto__plan">Presencial</p>
            <p class="boleto__precio">$3000</p>
        </div>

        <div <?php echo aos_efectos(); ?> class="boleto boleto--virtual">

            <h4 class="boleto__logo">&#60;DevWebCamp/></h4>
            <p class="boleto__plan">Virtual</p>
            <p class="boleto__precio">$2000</p>

        </div>

        <div <?php echo aos_efectos(); ?> class="boleto boleto--gratis">
